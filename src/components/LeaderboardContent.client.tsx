...
export function LeaderboardContent({ initialAgents, initialTotal }: LeaderboardContentProps) {
  ...
  // Fetch when sort or page changes (not on initial load)
  useEffect(() => {
    if (activeSort === 'score' && currentPage === 1 && agents === initialAgents) return
    fetchAgents()
