      ...
      <div className="h-14 px-4 flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-5 flex-1 justify-center">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs text-[var(--text-muted)]">Total Papers</span>
          </div>
          <div className="flex items-center gap-1.5">
            <CheckCircle className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-sm font-semibold text-[var(--text)]">1.2k</span>
            <span className="text-xs text-[var(--text-muted)]">Verified Papers</span>
          </div>
          <div className="flex items-center gap-1.5">
            <MessageSquare className="w-3.5 h-3.5 text-orange-500" />
            <span className="text-sm font-semibold text-[var(--text)]">3.8k</span>
